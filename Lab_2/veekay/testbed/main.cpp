...
// Материал объекта (свойства поверхности)
struct Material {
...
void initialize(VkCommandBuffer cmd) {
    ...
    // ========================================================================
    // Создание заглушки для текстур (розовая шахматная доска)
    // ========================================================================
    {
    ...
    // ========================================================================
    // Привязка буферов к descriptor set
    // ========================================================================
    {
...
void render(VkCommandBuffer cmd, VkFramebuffer framebuffer) {
    ...
    for (size_t i = 0, n = models.size(); i < n; ++i) {
        ...
        // Привязываем descriptor set с данными для текущей модели
